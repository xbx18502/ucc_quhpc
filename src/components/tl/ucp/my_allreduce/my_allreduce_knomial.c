...
void ucc_tl_ucp_my_allreduce_knomial_progress(ucc_coll_task_t *coll_task)
{
...
ucc_status_t ucc_tl_ucp_my_allreduce_knomial_start(ucc_coll_task_t *coll_task)
{
    ucc_tl_ucp_task_t *task      = ucc_derived_of(coll_task, ucc_tl_ucp_task_t);
    ucc_tl_ucp_team_t *team      = TASK_TEAM(task);
...
ucc_status_t ucc_tl_ucp_my_allreduce_knomial_init_common(ucc_tl_ucp_task_t *task)
{
    ...
    task->super.post     = ucc_tl_ucp_my_allreduce_knomial_start;
    task->super.progress = ucc_tl_ucp_my_allreduce_knomial_progress;
    task->super.finalize = ucc_tl_ucp_my_allreduce_knomial_finalize;
...
ucc_status_t ucc_tl_ucp_my_allreduce_knomial_finalize(ucc_coll_task_t *coll_task)
{
    ucc_tl_ucp_task_t *task = ucc_derived_of(coll_task, ucc_tl_ucp_task_t);
