...
ucc_status_t ucc_tl_ucp_my_allreduce_dbt_start(ucc_coll_task_t *coll_task)
{
...
ucc_status_t ucc_tl_ucp_my_allreduce_dbt_finalize(ucc_coll_task_t *coll_task)
{
    ucc_schedule_t *schedule = ucc_derived_of(coll_task, ucc_schedule_t);
    ucc_status_t    status;
                                           ...
                                           ucc_coll_task_t **task_h)
{
    ...
    schedule->super.post = ucc_tl_ucp_my_allreduce_dbt_start;
    schedule->super.progress = NULL;
    schedule->super.finalize =  ucc_tl_ucp_my_allreduce_dbt_finalize;
