 ...
 */
static ucc_status_t
ucc_tl_ucp_my_allreduce_sra_knomial_frag_start(ucc_coll_task_t *task)
{
    return ucc_schedule_start(task);
}

static ucc_status_t
ucc_tl_ucp_my_allreduce_sra_knomial_frag_finalize(ucc_coll_task_t *task)
{
...
static ucc_status_t
ucc_tl_ucp_my_allreduce_sra_knomial_frag_setup(ucc_schedule_pipelined_t *schedule_p,
...
static ucc_status_t
ucc_tl_ucp_my_allreduce_sra_knomial_frag_init(ucc_base_coll_args_t *coll_args,
                                           ...
                                           ucc_schedule_t **frag_p)
{
    ...
    UCC_CHECK_GOTO(ucc_task_subscribe_dep(rs_task, task, UCC_EVENT_COMPLETED),
                   out, status);
    schedule->super.finalize = ucc_tl_ucp_my_allreduce_sra_knomial_frag_finalize;
    schedule->super.post     = ucc_tl_ucp_my_allreduce_sra_knomial_frag_start;
    *frag_p                  = schedule;
    return UCC_OK;
out:
    return status;
...
static ucc_status_t
ucc_tl_ucp_my_allreduce_sra_knomial_finalize(ucc_coll_task_t *task)
{
    ucc_schedule_t *schedule = ucc_derived_of(task, ucc_schedule_t);
    ucc_status_t status;
...
static void
ucc_tl_ucp_my_allreduce_sra_knomial_get_pipeline_params(ucc_tl_ucp_team_t *team,
...
ucc_status_t
ucc_tl_ucp_my_allreduce_sra_knomial_init(ucc_base_coll_args_t *coll_args,
                                      ucc_base_team_t *team,
                                      ucc_coll_task_t **task_h)
{
    ...
    ucc_tl_ucp_my_allreduce_sra_knomial_get_pipeline_params(tl_team, args,
                                                         &pipeline_params);
    ...
    st = ucc_schedule_pipelined_init(&bargs, team,
                                     ucc_tl_ucp_my_allreduce_sra_knomial_frag_init,
                                     ucc_tl_ucp_my_allreduce_sra_knomial_frag_setup,
    ...
    schedule_p->super.super.finalize = ucc_tl_ucp_my_allreduce_sra_knomial_finalize;
    schedule_p->super.super.post     = ucc_tl_ucp_my_allreduce_sra_knomial_start;
